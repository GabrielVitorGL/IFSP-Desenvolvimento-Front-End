...
const obj_bt_redefine_texto = document.querySelector("#bt_redefine_texto");
...
obj_bt_redefine_texto.addEventListener("click", funRedefineTexto);
...
function funTrocaTexto() {
  if (obj_txt_texto_novo.value != "") {
    ...
    alert("Digite um texto para trocar!");
}

function funRedefineTexto() {
  obj_div_area_teste.innerHTML = "Área de Teste";
}